...
<div id="banner"> 
	<div id="banner-data"><br/>
		<div style="text-align:center;width:310px;margin-left:auto;margin-right:auto;">
                 <img src='images/Droitwich_Spa_High_School_logo.png' height='200px' width='200px'><br/><br/>
		<span style="color:#13A7C7;font-size:22px;">Droitwich </span><span style="color:#444;font-size:22px;">Public High School</span><br/><br/>
