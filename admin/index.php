...
<div id="banner"> 
	<div id="banner-data"><br/>
		...
		<span style="color:#13A7C7;font-size:22px;">Principal</span><span style="color:#444;font-size:22px;"> Panel</span><br/><br/>
   <div>&nbsp;<?php if(isset($_GET['status'])){ echo "<span style='color:red;font-size:12px;'>* Wrong username or password</span>"; } ?></div>		
	 	<form name="mysignin" method="POST" action="admin_signin_script.php" onsubmit="return validate()">
