                            ...
                            <table border='0' width='100%'>
                             <tr>
                              ...
                              <tr>
                               ...
                               <form name="myuser" method="POST" action="user_notes_script.php" enctype="multipart/form-data" onsubmit="return validate()">
...
<input type='file' name='image' style='font-size:12px;'><br/><br/>
	<input type='submit' name='submit' id='submit' value='Upload' style="color:white;font-size:12px;font-weight:bold;border-width:1px;border-style :solid;border-color:#444;-moz-border-radius: 5px;border-radius: 5px;padding:5px 5px 5px 5px;background:#444;"> 
				</form>
                                </td>
                                 </tr>
                             ...
                             <tr>
                              ...
                              <tr>
                               ...
                               <?php
                                                                ...
                                                                $qu="SELECT * from user_notes WHERE t_id = '$user' ORDER by id DESC LIMIT 3";
                                                                $show=mysql_query($qu);
     ...
     <table width='90%' align='center' border='0' bgcolor='#ffffff' style='color:#444;font-size:12px;'>
            ...
            <td valign='top' style='padding:5px;color:444;'>
              ...
              <img src='notes/$notes' height='100px' width='100px' style='border:1px solid #444;'>
              </td>
                                       </tr>
                                       </table><br/>";
            ...
            <td valign='top' width='100%' style='padding:5px;font-size:12px;color:#444;'> 
                <a href='view_complete_notes.php' style='font-size:12px;color:#13A7C7;text-decoration:none;'>View all notes</a>
            </td>
            </tr>
            </table>";
                               }
