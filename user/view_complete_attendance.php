                            ...
                            <table border='0' width='100%'>
                              <tr>
                               ...
                               <?php
                                                                ...
                                                                $q1="SELECT count(*) from temp_attendance WHERE t_id = '$user'";
                                                                $result1=mysql_query($q1);
                                                                $show1=mysql_fetch_array($result1);
                                                                //echo $show1;
                                                                $total=$show1[0];
                                                                //echo $total;
                                                                $qu="SELECT * from temp_attendance WHERE t_id = '$user' ORDER by id DESC LIMIT $startrow,".showmax;
                                                                $show=mysql_query($qu);
...
if($page>0)
{?>
<a href="view_complete_attendance.php?curpage=<?php echo ($page-1); ?>" style='background-color:#5898b4;padding:4px;color:#ffffff;text-decoration:none;'>prev</a>
<?php
}
else
{
...
{?>
<a href="view_complete_attendance.php?curpage=<?php echo ($page+1); ?>" style='background-color:#5898b4;padding:4px;color:#ffffff;text-decoration:none;'>next</a>
<?php
}
echo "</td>
                                       </tr>
